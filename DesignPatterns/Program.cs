...
namespace DesignPatterns
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            logger.LogToDatabase("Meadian", gudinator.Mathinate(thisATurkeyYo, new Medianator()).ToString());
            Console.WriteLine("Mean Ass Turkey: " + gudinator.Mathinate(thisATurkeyYo, new Meaninator()));
            logger.LogToFile("Mean", gudinator.Mathinate(thisATurkeyYo, new Meaninator()).ToString());
            Console.WriteLine("\n");
